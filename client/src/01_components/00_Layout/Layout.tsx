...
function Layout({ children }: { children: React.ReactNode; }) {
  return (
    <div className="flex-column" style={{height: "100vh", fontFamily: "DungGeunMo"}}>
    {/* 전체 레이아웃 컨테이너 */}
    {/* d-flex: Flexbox 활성화 */}
    ...
    {/* vh-100: 화면 높이 100%로 설정 */}
      ...
      {/* p-3: 내부 여백(Padding)을 1rem로 설정 */}
        ...
        <nav className="d-flex gap-3">
          ...
          {/* <a href="/NftChartPage" className="text-decoration-none text-reset">Nft_Chart</a> */}
          <a href="/NftGamePage" className="text-decoration-none text-reset">Nft_Game</a>
          <a href="/NftMyPage" className="text-decoration-none text-reset">My_Page</a>
        </nav>
      </header>
